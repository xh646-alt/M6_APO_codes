% Execution Script for Portfolio Optimization and Performance Evaluation with shrinkage covariance
...
xt_all=cat(3,xt_naive,xt_VT,xt_minvar,xt_meanvar,xt_BS,xt_BL);
